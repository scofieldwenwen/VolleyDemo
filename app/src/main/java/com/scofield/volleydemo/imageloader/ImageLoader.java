package com.scofield.volleydemo.imageloader;
...
public class ImageLoader {
    ...
    private int getImageViewFieldValue(Object object, String fieldName) {
        ...
        try {
            ...
            Log.e("getImageViewFieldValue", "getImageViewFieldValue: "+e );
        }
        return value;
    }
     ...
     */
    public void loadImage(String url, int width, int height, final ImageView imageView, int defaultImageResId, int errorImageResId) {
        com.android.volley.toolbox.ImageLoader.ImageListener listener = com.android.volley.toolbox.ImageLoader.getImageListener(imageView, defaultImageResId,
                errorImageResId);
